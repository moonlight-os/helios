...
can use Helios to create and sell products or services without needing to seek permission or pay a fee.

However, it is important to note that the GPL-3.0 license does not grant any rights to distribute or sell the encoders
contained within Helios. If you plan to sell access to Helios as part of their distribution, you are responsible
...
In summary, while Helios is free to use, it is the user's responsibility to ensure compliance with all applicable
licensing requirements when redistributing the software as part of a commercial offering. If you have any questions or
concerns about using Helios in a commercial setting, we recommend consulting with a lawyer.
